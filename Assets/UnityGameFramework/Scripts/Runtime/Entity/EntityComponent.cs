...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class EntityComponent : GameFrameworkComponent
    {
        ...
        private void Start()
        {
            ...
            {
                if (!AddEntityGroup(m_EntityGroups[i].Name, m_EntityGroups[i].InstanceAutoReleaseInterval, m_EntityGroups[i].InstanceCapacity, m_EntityGroups[i].InstanceExpireTime, m_EntityGroups[i].InstancePriority, m_EntityGroups[i].Position, m_EntityGroups[i].InstanceRoot))
                {
        ...
        public bool AddEntityGroup(string entityGroupName, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority, Vector3 position, GameObject instanceRoot)
        {
            ...
            EntityGroupHelperBase entityGroupHelper = Helper.CreateHelper(m_EntityGroupHelperTypeName, m_CustomEntityGroupHelper, EntityGroupCount, instanceRoot);
