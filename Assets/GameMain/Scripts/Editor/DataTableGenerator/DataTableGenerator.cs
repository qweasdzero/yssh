...
namespace StarForce.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        ...
        {
            return new DataTableProcessor(Path.Combine(DataTablePath, dataTableName + ".txt"), Encoding.Default, 1, 2, null, 3, 4, 1);
        }
        ...
        {
            string binaryDataFileName = Path.Combine(DataTablePath, dataTableName + ".bytes");
        ...
        public static void GenerateCodeFile(DataTableProcessor dataTableProcessor, string dataTableName)
        {
            ...
            string csharpCodeFileName = Path.Combine(CSharpCodePath, "DR" + dataTableName + ".cs");
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", Constant.AssemblyInfo.Namespace);
